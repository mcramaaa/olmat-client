...
const academicInfoSchema = z.object({
  ...
  mathLevel: z.enum(["beginner", "intermediate", "advanced"], { message: "Please select your math level." }),
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Please fill out all required information to register for the Math Olympiad</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="academic" className="space-y-4 pt-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g., 12th Grade, 2nd Year University" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Previous Math Competitions (Optional)</FormLabel>
                      <FormControl>
                        <Textarea
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 mt-4">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel>I agree to the terms and conditions of the Math Olympiad 2025</FormLabel>
                        <FormDescription>
