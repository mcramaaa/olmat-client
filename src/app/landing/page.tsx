          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">
                UINSA Math Olympiad 2025
              </h3>
              <p className="text-sm opacity-80">
                The premier mathematics competition for students across
                Indonesia, organized by UIN Sunan Ampel Surabaya.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="mt-6">
                <p className="text-sm opacity-80">
                  © 2025 UINSA Math Olympiad. All rights reserved.
                </p>
              </div>
            </div>
          </div>
