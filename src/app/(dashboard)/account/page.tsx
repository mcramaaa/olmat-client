              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Receive updates about your registration status</p>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Label htmlFor="registration-updates" className="sr-only">
                      Registration Updates
                    </Label>
                    <Input id="registration-updates" type="checkbox" className="h-4 w-4" defaultChecked />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Receive reminders about upcoming competition dates</p>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Label htmlFor="competition-reminders" className="sr-only">
                      Competition Reminders
                    </Label>
                    <Input id="competition-reminders" type="checkbox" className="h-4 w-4" defaultChecked />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Receive marketing emails about future events</p>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Label htmlFor="marketing-emails" className="sr-only">
                      Marketing Emails
                    </Label>
                    <Input id="marketing-emails" type="checkbox" className="h-4 w-4" />
                  </div>
                </div>
              </div>
            </CardContent>
